                ...
                try:
                    ...
                    for raw in course_rows:
                        ...
                        if event is not None:
                            ...
                            # Assignment notifications wait for the persisted AI gate (or
                            # deterministic critical fallback) in AnalysisWorker.
                    ...
                    if is_canvas:
                        ...
                        if source:
                            ...
                            source.state = (
                                "DEGRADED" if adapter.errors else "HEALTHY"
                            )
                            source.last_error = (
                                "; ".join(
                                    f"{kind}:{code}"
    ...
    def store_observation(
        ...
        *,
        ...
        event = ChangeEvent(
            ...
            summary=summarize_change(old_data, raw.structured),
            semantic_key=semantic_key,
        )
        db.add(event)
        db.flush()
